...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    switch (msg) {
        case WM_CREATE: {
            ...
            lvc.cx = 100; lvc.pszText = (LPWSTR)L"状态"; ListView_InsertColumn(hListView, 1, &lvc);
            lvc.cx = 80;  lvc.pszText = (LPWSTR)L"PID"; ListView_InsertColumn(hListView, 2, &lvc);
            lvc.cx = 100; lvc.pszText = (LPWSTR)L"类型"; ListView_InsertColumn(hListView, 3, &lvc);
            ...
            lvc.cx = 100; lvc.pszText = (LPWSTR)L"运行时间"; ListView_InsertColumn(hListView, 6, &lvc);
